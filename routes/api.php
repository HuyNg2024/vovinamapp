...
Route::group(['middleware' => ['auth:api']], function () {
    ...
    // Route cho giáo viên xem thông tin điểm danh 1 lớp trong CLB
    Route::get('/teacher/view-checkin', [CheckinController::class, 'teacherViewCheckin']);//30 //add en
...
// hiện ds các class của coach
Route::get('/teacher/classes/getall',[CheckinController::class, 'getTeacherClasses']);//22 //add en
...
// Đăng ký thi lên đai
Route::post('/register-belt', [Atg_memberController::class, 'dangKyDai']);
